...
import 'package:core/widgets/texts/body_large_text.dart';
import 'package:core/widgets/texts/center_body_medium_text.dart';
import 'package:flutter/material.dart';
import 'package:flutter/semantics.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';
import 'package:go_router/go_router.dart';
import 'package:repo_search/src/presentation/providers/repo_search.dart';
...
class SearchScreenState extends ConsumerState<SearchScreen> {
  ...
  void _onScrollListener() {
    ...
    if (maxScroll - currentScroll <= kScrollDelta) {
      ...
      ref.read(repoSearchProvider.notifier).loadMore();
      setState(() {
  ...
  Future<void> _submit(String value) async {
    ...
    if (query.isNotEmpty) {
      await ref.read(repoSearchProvider.notifier).search(query);
    }
  }
  ...
  Future<void> _clearSearch() async {
    ...
    await ref.read(repoSearchProvider.notifier).clearSearch('');
  }
                  ...
                  return Column(
                    ...
                    children: [
                      ...
                      Semantics(
                        ...
                        child: TextButton(
                          onPressed: () =>
                              ref.read(repoSearchProvider.notifier).search(),
